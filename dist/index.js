...
var OssoContext = React.createContext(defaultValue);
var OssoProvider = function (_a) {
    var children = _a.children, clientOptions = _a.client;
    var client = buildClient(clientOptions);
    return React__default.createElement(OssoContext.Provider, { value: { client: client } },
        children,
        " ");
};
...
var ACCOUNTS_QUERY = client.gql(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  query EnterpriseAccounts {\n    enterpriseAccounts {\n      id\n      domain\n      name\n      status\n    }\n  }\n"], ["\n  query EnterpriseAccounts {\n    enterpriseAccounts {\n      id\n      domain\n      name\n      status\n    }\n  }\n"])));
var useEnterpriseAccounts = function () {
    var client$1 = React.useContext(OssoContext).client;
    if (client$1 === undefined) {
        throw new Error('createEnterpriseAccount must be used inside an OssoProvider');
    }
    var _a = client.useQuery(ACCOUNTS_QUERY, { client: client$1 }), data = _a.data, loading = _a.loading, error = _a.error;
    // useEffect(() => {
    //   client
...
var ACCOUNT_QUERY = client.gql(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  query EnterpriseAccount($domain: String!) {\n    enterpriseAccount(domain: $domain) {\n      id\n      domain\n      name\n      status\n      identityProviders {\n        id\n        service\n        acsUrl\n        ssoCert\n        ssoUrl\n      }\n    }\n  }\n"], ["\n  query EnterpriseAccount($domain: String!) {\n    enterpriseAccount(domain: $domain) {\n      id\n      domain\n      name\n      status\n      identityProviders {\n        id\n        service\n        acsUrl\n        ssoCert\n        ssoUrl\n      }\n    }\n  }\n"])));
var useEnterpriseAccount = function (domain) {
    var client = React.useContext(OssoContext).client;
...
var _a;
var providers = (_a = {},
    _a[exports.Providers.Azure] = azure,
    _a[exports.Providers.Okta] = okta,
    _a);
...
function IdpGeneratedFieldsComponent(_a) {
    ...
    var _c = React.useReducer(configReducer, initialConfigState), state = _c[0], dispatch = _c[1];
    ...
    return (React__default.createElement("div", { style: containerStyle },
        metadataXml && React__default.createElement(UploadComponent, __assign({}, metadataXml)),
        metadataUrl && React__default.createElement(InputComponent, __assign({}, metadataUrl)), (_b = manual) === null || _b === void 0 ? void 0 :
        _b.map(function (field) { return (React__default.createElement(InputComponent, __assign({ key: field.name, onChange: function (value) {
                return dispatch({
                    field: field.name,
                    value: value,
                });
            } }, field.inputProps, { value: state[field.name] }))); }),
        React__default.createElement(ButtonComponent, { onClick: function () { return configureProvider(fullIdentityProvider.id, state); } }, "Save")));
}
...
var HTMLInputComponent = function (_a) {
    ...
    return (React__default.createElement("label", null,
        label,
        React__default.createElement("input", __assign({}, inputProps, { onChange: function (event) { return onChange && onChange(event.target.value); } }))));
};
...
function OssoGeneratedFieldsComponent(_a) {
    ...
    var _b = React.useState(), fields = _b[0], setFields = _b[1];
    ...
    return (React__default.createElement("div", { style: containerStyle }, fields === null || fields === void 0 ? void 0 : fields.map(function (field) { return (React__default.createElement(InputComponent, __assign({ key: field.name }, field.inputProps, { value: fullIdentityProvider[field.name] }))); })));
}
var HTMLInputComponent$1 = function (_a) {
    var label = _a.label, inputProps = __rest(_a, ["label"]);
    return (React__default.createElement("label", null,
        label,
        React__default.createElement("input", __assign({}, inputProps, { onChange: undefined }))));
};
...
exports.IdpGeneratedFields = IdpGeneratedFieldsComponent;
exports.OssoContext = OssoContext;
exports.OssoGeneratedFields = OssoGeneratedFieldsComponent;
exports.OssoProvider = OssoProvider;
exports.configureIdentityProvider = configureIdentityProvider;
exports.createEnterpriseAccount = createEnterpriseAccount;
exports.createIdentityProvider = createIdentityProvider;
exports.useEnterpriseAccount = useEnterpriseAccount;
exports.useEnterpriseAccounts = useEnterpriseAccounts;
exports.useIdentityProvider = useProvider;
exports.useOssoFields = useOssoFields;
